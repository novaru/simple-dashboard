                                    ...
                                    <div class="header-dropdown-list message-menu">
                                        <div class="dropdown-item d-flex p-4">
                                            ...
                                            <span
                                                ...
                                                data-bs-image-src="<?= base_url('/'); ?>assets/images/pngs/4.jpg"></span>
                                            <div class="wd-50p">
                                        ...
                                        <div class="dropdown-item d-flex p-4">
                                            ...
                                            <span
                                                class="avatar avatar-xl br-5 me-3 align-self-center cover-image"
                                                data-bs-image-src="<?= base_url('/'); ?>assets/images/pngs/6.jpg"></span>
                                            <div class="wd-50p">
                                        ...
                                        <div class="dropdown-item d-flex p-4">
                                            ...
                                            <span
                                                class="avatar avatar-xl br-5 me-3 align-self-center cover-image"
                                                data-bs-image-src="<?= base_url('/'); ?>assets/images/pngs/8.jpg"></span>
                                            <div class="wd-50p">
                                        ...
                                        <div class="dropdown-item d-flex p-4">
                                            ...
                                            <span
                                                class="avatar avatar-xl br-5 me-3 align-self-center cover-image"
                                                data-bs-image-src="<?= base_url('/'); ?>assets/images/pngs/1.jpg"></span>
                                            <div class="wd-50p">
                                        ...
                                        <div class="dropdown-item d-flex p-4">
                                            ...
                                            <span
                                                class="avatar avatar-xl br-5 me-3 align-self-center cover-image"
                                                data-bs-image-src="<?= base_url('/'); ?>assets/images/pngs/3.jpg"></span>
                                            <div class="wd-50p">
                                ...
                                <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                    ...
                                    <div class="message-menu message-menu-scroll">
                                        ...
                                        <a class="dropdown-item d-flex" href="chat.html">
                                            <span
                                                class="avatar avatar-md brround me-3 align-self-center cover-image"
                                                data-bs-image-src="<?= base_url('/'); ?>assets/images/users/3.jpg"></span>
                                            <div class="wd-90p">
                                                <div class="d-flex">
                                ...
                                <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                    <div class="drop-heading">
                                        <div class="text-center">
                                            <h5 class="text-dark mb-0 fs-14 fw-semibold"><?= esc($user['name']) ?></h5>
